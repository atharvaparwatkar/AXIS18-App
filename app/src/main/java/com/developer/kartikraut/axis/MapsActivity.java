...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,AdapterView.OnItemSelectedListener {
    ...
    Marker vnit_marker,civil_marker,elec_marker,phy_marker,mech_marker,audi_marker,meta_marker,hostel_section_marker,ece_marker,chem_marker,canara_marker,archi_marker,audi_lawns_marker,apm_marker,lib_lawns_marker,cse_marker,behind_meta_marker;
    LatLng vnit,civil,electrical,phy,mech,audi,meta,hostel_section,ece,chem,canara,archi,audi_lawns,apm,lib_lawns,cse,behind_meta;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        behind_meta = new LatLng(21.123822,79.050681);
        ...
        behind_meta_marker = mMap.addMarker(new MarkerOptions().position(behind_meta).title("Behind Metallurgy Department"));
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
        ...
        else if (item == "ELECTRO GT") {
            moveCamera(audi_lawns,audi_lawns_marker,item,"ELECTRO GT");
        }
        ...
        else if(item == "ISRO EXHIBITION"){
            moveCamera(behind_meta,behind_meta_marker,item,"BEHIND METALLURGY DEPARTMENT");
        }
