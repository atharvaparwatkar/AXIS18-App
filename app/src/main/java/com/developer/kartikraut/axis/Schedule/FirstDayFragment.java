...
public class FirstDayFragment extends Fragment {
    ...
    RecyclerView rv_day1;
    TextView event_name,event_time,event_venue;
    private ProgressDialog pDialog;
    List<ScheduleClass> scheduleClasses;
    ScheduleAdapter adapter;

    String day1_events_url = "http://axisvnit.org/api/schedule/1/?format=json";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv_day1 = (RecyclerView)view.findViewById(R.id.rv_day1);

        initializeData();

        if (scheduleClasses == null) {
            Toast.makeText(getContext(), "Schedule will be updated soon1", Toast.LENGTH_SHORT).show();
        }
        else {
            LinearLayoutManager llm = new LinearLayoutManager(this.getContext());
            rv_day1.setLayoutManager(llm);
    ...
    private void initializeData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, day1_events_url, new Response.Listener<String>() {
            @Override
