...
public class SecondDayFragment extends Fragment {
    ...
    RecyclerView rv_day2;
    TextView event_name,event_time,event_venue;
    private ProgressDialog pDialog;
    List<ScheduleClass> scheduleClasses;
    ScheduleAdapter adapter;

    String day2_events_url = "http://axisvnit.org/api/schedule/2/?format=json";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rv_day2 = (RecyclerView)view.findViewById(R.id.rv_day2);
    ...
    private void initializeData() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, day2_events_url, new Response.Listener<String>() {
            @Override
